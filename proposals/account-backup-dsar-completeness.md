...
**Coverage gaps remaining after v0.6.0 (informational only, no chips):**
...
- Webapp coverage caveat (v0.6.0+): `pryv-account-backup-webapp` omits attachments / HFS series / webhooks / per-file sha256 manifest. Subjects whose disclosure needs these resources should be routed at the CLI flavor.
